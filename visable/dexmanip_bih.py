...
class DexManipBiH:
    ...
    def _create_envs(self):
        ...
        self.dexhand_rh_pose.p = gymapi.Vec3(-table_half_width, -0.12, table_surface_z + ROBOT_HEIGHT)
        self.dexhand_rh_pose.r = gymapi.Quat.from_euler_zyx(0, -np.pi / 2, 0)
        self.dexhand_lh_pose = deepcopy(self.dexhand_rh_pose)
        self.dexhand_lh_pose.p = gymapi.Vec3(-table_half_width, 0.12, table_surface_z + ROBOT_HEIGHT)
